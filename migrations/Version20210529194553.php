 ...
 */
final class Version20210529194553 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contract ADD CONSTRAINT FK_E98F28591D55B925 FOREIGN KEY (auto_id) REFERENCES auto (id) NOT DEFERRABLE INITIALLY IMMEDIATE');
